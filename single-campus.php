...
/* 
! ---> The following code is not currently being used. 
 * Can modify this query to include a relationship 
 * between campuses and events.
  TODO ----> Finish this as extra credit.
 * 
 */
          $today = date('Ymd');
